...
pretrained = 'https://download.openmmlab.com/mmclassification/v0/efficientnetv2/efficientnetv2-m_3rdparty_in21k_20221220-073e944c.pth'
...
train_pipeline = [
    ...
    dict(type='EfficientNetRandomCrop', scale=384, crop_padding=0),     # Random scaling and cropping
...
test_pipeline = [
    dict(type='LoadImageFromFile'),     # read image
    # dict(type='ResizeEdge', scale=256),  
    dict(type='EfficientNetCenterCrop', crop_size=480,crop_padding=0),     # center crop
    dict(type='PackInputs'),                 # prepare images and labels
]
